...
import discussWork from "../../../assets/images/discussing-work.jpg";

const FeaturesInfluencer: React.FC = () => {
  return (
    <>
      <h2 className="mb-20 text-center text-3xl font-bold">Features</h2>

      <div className=" mb-12 flex flex-wrap items-center">
        <div className=" w-full h-2/4 shrink-0 grow-0 basis-auto md:px-6 lg:mb-0 lg:w-5/12">
          <div
