...
const BannerOffer: React.FC = () => {
  return (
    <div className="alert alert-dismissible fade show fixed z-[1030] w-full items-center justify-between bg-primary px-6 text-center text-white md:flex md:text-left">
      <div className="flex flex-wrap items-center justify-center md:mb-0 md:justify-start">
        ...
        <strong className="mr-1">Limited offer!</strong> Get it now before it's
        to late
      </div>
